...
#grouping by year removes seasonality
...
inflow_data_yearly <- data.frame(my_year, y = inflow_data_yearly)

ggplot(data = inflow_data_yearly, aes(x = my_year, y = y)) +
...
summary(MannKendall(inflow_data_yearly$y))
```
...
print(cor(inflow_data_yearly$y, my_year, method = "pearson"))

#with cor.test you can get test statistics
print(cor.test(inflow_data_yearly$y, my_year, method = "spearman"))
...
print(adf.test(inflow_data_yearly$y, alternative = "stationary"))
